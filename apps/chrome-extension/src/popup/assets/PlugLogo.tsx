...
function SvgComponent(props: SVGProps<SVGSVGElement>) {
    return (
        <svg width={32} height={32} viewBox="0 0 18 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0)">
                <path d="M3.36569 0.413793C3.36569 0.185261 3.54471 0 3.76554 0H5.59153C5.81236 0 5.99138 0.185261 5.99138 0.413793V6.66207H3.36569V0.413793Z" fill="#031514" />
                <path d="M11.9488 0.413793C11.9488 0.185261 12.1278 0 12.3487 0H14.1747C14.3955 0 14.5745 0.185261 14.5745 0.413793V6.66207H11.9488V0.413793Z" fill="#031514" />
